...
void usage(){
    ...
    printf("To list all users, input: 2\n");
    printf("To invite other player, input: 3 Your name Other's name\n");
    ...
    while(1)
    {
        ...
        switch (instruction)
        {
            ...
            case 6: {
                ...
                printf("Please input: '-0' ~ '-8' for placing your chess\n");
                clear_borad(board);
                print_board(board);
                break;
            }
